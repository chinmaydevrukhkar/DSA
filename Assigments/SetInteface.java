...
class Tester {
	...
	public static Set<Student> findUnique(List<Student> students) {
		...
		return uniqueStudent;//Implement your logic here and change the return statement accordingly 
	...
	public static Set<Student> findDuplicates(List<Student> students) {
	    ...
	    Set<Student> uniqueStudent = new HashSet<Student>();
	    Set<Student> duplicateStudent = new HashSet<Student>();
	    for(Student student : students){
	        if(!uniqueStudent.add(student)){
	            duplicateStudent.add(student);
	         }
	    }
		//Implement your logic here and change the return statement accordingly 
